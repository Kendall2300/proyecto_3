    ...
    while True:
        ...
        for face_encoding, face_location in zip(encodings, locations):
            ...
            if True in results:
                ...
                top_left = (face_location[3], face_location[8])
                ...
                cv2.putText(image, match, (face_location[3]+10, face_location[2]+15), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (200,200,200), FONT_THIKNESS)
